...
ifdef ARDUINO_DIR
	...
	ARDUINO_CORE_PATH = $(ARDUINO_DIR)/hardware/arduino/cores/arduino
        $(call show_config_variable,ARDUINO_CORE_PATH,[COMPUTED],(from ARDUINO_DIR))
    else
...
CPPFLAGS      += -mmcu=$(MCU) -DF_CPU=$(F_CPU) -DARDUINO=$(ARDUINO_VERSION) \
        -I$(ARDUINO_CORE_PATH) -I$(ARDUINO_VAR_PATH)/$(VARIANT) -I$(ARDUINO_DIR)/hardware/arduino/cores/arduino \
